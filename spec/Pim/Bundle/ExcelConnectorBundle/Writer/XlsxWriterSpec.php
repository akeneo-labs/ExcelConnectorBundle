...
class XlsxWriterSpec extends ObjectBehavior
{
    ...
    function let(ExcelBuilderFactory $factory, ExcelBuilderInterface $builder)
    {
    ...
    function it_adds_item_to_the_builder(ExcelBuilderInterface $builder)
    {
    ...
    function it_creates_an_excel_file_on_flush(ExcelBuilderInterface $builder)
    {
